    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unseen_bookings', models.IntegerField(default=0, verbose_name='Unseen booking requests count')),
                ...
                ('referral_active', models.BooleanField(default=False, verbose_name='Activate referral for this user')),
                ('referral_code', models.CharField(blank=True, max_length=25, null=True, verbose_name='Referral Code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, verbose_name='Campaign Title')),
                ('description', models.CharField(max_length=255, verbose_name='Campaign Description')),
                ('discount', models.IntegerField(default=0, verbose_name='Referral revenue (%)')),
                ('enable_two_way', models.BooleanField(default=False, help_text='Referee can avail 100% revenue*', verbose_name='Enable two way rewards')),
                ('valid_from', models.DateField(verbose_name='Campaign Valid from')),
                ('valid_till', models.DateField(verbose_name='Campaign Valid to')),
                ('valid_for_days', models.IntegerField(verbose_name='No of days referral can earn')),
                ('request_for_user', models.IntegerField(verbose_name='No of requests for which referred person can avail 100% revenue')),
                ('max_referral_amount', models.IntegerField(verbose_name='Maximum referral amount referrer can earn')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Created Date')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Created Date')),
                ('referee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='refer_referee', to=settings.AUTH_USER_MODEL)),
                ('referrer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='refer_referrer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='avatar_photo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='profile_pic', to='users.ProfileImage'),
        ),
        migrations.AddField(
            model_name='stargramzuser',
            name='featured_photo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='featured_image', to='users.ProfileImage'),
        ),
        migrations.AddField(
            model_name='stargramzuser',
            name='groups',
